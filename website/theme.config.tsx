...
const config: DocsThemeConfig = {
  logo: (
    <span className="ac-logo">
      <span className="ac-logo-leaf">🌿</span> Zero Auth
    </span>
  ),
  project: {
    link: 'https://github.com/zero-labsco/zero_auth'
  },
  docsRepositoryBase:
    'https://github.com/zero-labsco/zero_auth/tree/main/website',
  footer: {
    content: 'Zero Auth · MPL-2.0'
  },
  ...
  head: (
    <>
      <link rel="icon" href="/zero_auth/favicon.svg" type="image/svg+xml" />
